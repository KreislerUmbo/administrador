        ...
        <div class="p-6 ">
            <div class="space-y-6">
                @foreach ($options as $option)
                    <div class="p-6 rounded-lg border border-s-gray-200 relative" wire:key="option-{{ $option->id }}">
                                ...
                                @switch($option->type)
                                    @case(1)
                                        ...
                                        <span
                                            ...
                                            {{ $feature->description }}
                                            <button class="ml-0.55" onclick="confirmDelete({{ $feature->id }},'feature')"
                                    ...
                                    @case(2)
                                        ...
                                        <div class=" relative">
                                            ...
                                            <button
                                                ...
                                                onclick="confirmDelete({{ $feature->id }},'feature')" {{--  wire:click="deleteFeature({{$feature->id}})" --}} >
        ...
        <x-slot name='content'>
            ...
            <div class=" grid grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <x-input wire:model="newOption.name" class=" w-full" placeholder=" Ingrese el Nombre" />
                </div>
                        ...
                        <div class=" grid grid-cols-2 gap-6 ">
                            ...
                            <div>
                                ...
                                <x-input wire:model="newOption.features.{{ $index }}.description"
                                    class=" w-full" placeholder=" Ingrese la descripcion " />
                            </div>
