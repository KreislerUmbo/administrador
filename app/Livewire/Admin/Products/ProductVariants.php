...
class ProductVariants extends Component
{
    ...
    function generarVariantes()
    {
        ...
        $this->dispatch('variant-generate'); //genera un evento para que cuando se guarde el campo stock desaparesca, esto es enviado o recibido en livewire/ProductEdit cuya funcio es updateProduct 
    }
